...
public class Builtin {
	/////////////////////////////////Δmax//////////////////
	public static int dsum(int a, int b) {
		Assert.impossible();
		return -1;
	}

	public static long dsum(long a, long b) {
		Assert.impossible();
		return -1;
	}

	public static float dsum(float a, float b) {
		Assert.impossible();
		return -1;
	}
	...
	/////////////////////////////////Δmin//////////////////
	public static int dmin(int a, int b) {
		Assert.impossible();
		return -1;
	}

	public static long dmin(long a, long b) {
		Assert.impossible();
		return -1;
	}

	public static float dmin(float a, float b) {
		Assert.impossible();
		return -1;
	}
	...
	/////////////////////////////////Δmax//////////////////
	public static int dmax(int a, int b) {
		Assert.impossible();
		return -1;
	}

	public static long dmax(long a, long b) {
		Assert.impossible();
		return -1;
	}

	public static float dmax(float a, float b) {
		Assert.impossible();
		return -1;
	}
	...
	/////////////////////////////////Δcount//////////////////
	public static int dcount(int a, int b) {
		Assert.impossible();
		return -1;
	}

	public static int dcount(long a, long b) {
		Assert.impossible();
		return -1;
	}

	public static int dcount(float a, float b) {
		Assert.impossible();
		return -1;
	}

	public static int dcount(double a, double b) {
		Assert.impossible();
		return -1;
	}
