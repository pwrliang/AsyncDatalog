...
public class Table implements Serializable {
    ...
    public void setVisitorInterface(String _visitorInterface) {
        visitorInterface = _visitorInterface;
    }

    public String visitorInterface() {
        return visitorInterface;
    }

    public TableDecl decl() {
        return decl;
    }
    ...
    public int groupbyColNum() {
        return groupby;
    }

    public int groupbyRestColNum() {
        return columns.length - groupby;
    }

    public boolean hasIndexby() {
        return indexedCols().length > 0;
    }

    public boolean hasSortby() {
        return sortbyCols().length > 0;
    }
    ...
    public boolean isConcurrent() {
        return decl.isConcurrent();
    }

    public boolean isApprox() {
        return decl.isApproxSet();
    }

    public boolean isPredefined() {
        return decl.isPredefined();
    }

    public boolean isMultiSet() {
        return decl.isMultiSet();
    }
