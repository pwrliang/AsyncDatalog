...
public class QueryListener implements QueryProtocol {
	...
	public DistEngine getDistEngine() {
		return distEngine;
	}
...
//			Server server = RPC.getServer(this, masterAddr, queryListenPort,numHandlers, false, hConf);
            Server server = new RPC.Builder(hConf).
                    setInstance(this).
                    setProtocol(QueryProtocol.class).
                    setBindAddress(masterAddr).
                    setPort(queryListenPort).
	...
	public synchronized DistEngine getEngine() { return distEngine; }
